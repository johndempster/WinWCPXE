;===============================================================
;==                                                           ==
;== This Inno Setup script file is an example of how to make  ==
;== a TVicHW32-based application installation.                ==
;==                                                           ==
...
;==                                                           ==
;== Of course, you must change "TVicHW32" name if you have    ==
;== TVicHW32 customized version.                              ==
;==                                                           ==
...
OutputBaseFilename=MySuperApplicationSetup
...
; this line installs the TVicHW32.sys driver under WinNT/2000/XP
Source: "TVicHW32.sys"; DestDir: "{win}\system32\drivers"; Flags: ignoreversion restartreplace; MinVersion: 0,3.51
; this line installs the TVicHW32.vxd driver under Win95/98/ME
Source: "TVicHW32.vxd"; DestDir: "{win}\system";           Flags: ignoreversion; MinVersion: 4,0

; change application name
Source: "MySuperApplication.exe"; DestDir: "{app}"
; the Inno Setup Installation script (this file)
Source: "TVicHW32.iss"; DestDir: "{app}"; Flags: ignoreversion;
...
; DO NOT REMOVE OR CHANGE THE FOLLOWING 5 LINES!! this part is for NT/2000/XP only (starts the driver after reboot)

Root: HKLM; Subkey: "System\CurrentControlSet\Services\TVicHW32"; ValueType: dword;  ValueName: "Type";         ValueData: "1"; MinVersion: 0,3.51; Flags: uninsdeletekey
Root: HKLM; Subkey: "System\CurrentControlSet\Services\TVicHW32"; ValueType: dword;  ValueName: "Start";        ValueData: "2"; MinVersion: 0,3.51; Flags: uninsdeletekey
Root: HKLM; Subkey: "System\CurrentControlSet\Services\TVicHW32"; ValueType: dword;  ValueName: "ErrorControl"; ValueData: "1"; MinVersion: 0,3.51; Flags: uninsdeletekey
Root: HKLM; Subkey: "System\CurrentControlSet\Services\TVicHW32"; ValueType: string; ValueName: "Group";        ValueData: "Extended Base"; MinVersion: 0,3.51; Flags: uninsdeletekey
Root: HKLM; Subkey: "System\CurrentControlSet\Services\TVicHW32"; ValueType: string; ValueName: "Parameters";   ValueData: ""; MinVersion: 0,3.51; Flags: uninsdeletekey
